...
public class PlayerNetworkSetup_FinalIK : MonoBehaviour
{
    ...
    public List<SkinnedMeshRenderer> AvatarSkinnedMeshRenderer = new List<SkinnedMeshRenderer>();

    private void Awake()
    {
        _photonView = GetComponent<PhotonView>();
        AvatarSkinnedMeshRenderer.ForEach((skinMesh) => skinMesh.enabled = false);
    ...
    {
        AvatarSkinnedMeshRenderer.ForEach((skinMesh) => skinMesh.enabled = true);
    }
}
