...
namespace Photon.Pun.Demo.Asteroids
{
    public class LobbyMainPanel : MonoBehaviourPunCallbacks
    {
        ...
        {
            object playMode;
            if (PhotonNetwork.CurrentRoom.CustomProperties.TryGetValue("map", out playMode))
            {
                if ((string)playMode == "Multiplayer")
                {
                ...
                {
                    PhotonNetwork.LoadLevel("SingleplayerScene");
                }
            }
        }
        ...
        public void OnCreateRoomButtonClicked(string playMode)
        {
            ...
            Hashtable customRoomProperties = new Hashtable() { { "map", playMode } };
